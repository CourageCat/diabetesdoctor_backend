...
public class User : DomainEntity<ObjectId>
{
    ...
    public static User Create(ObjectId id, UserId userId, HospitalId? hospitalId, FullName fullname, Image avatar, string? phoneNumber, string? email, Role role)
    {
        return new User
        {
            Id = id,
    ...
    public void Modify(FullName? fullname, Image? avatar, string? phoneNumber, string? email)
    {
