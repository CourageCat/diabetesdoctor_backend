...
public interface IConversationRepository : IRepositoryBase<Conversation>
{
    ...
    Task<UpdateResult> ToggleGroupVisibilityAsync(IClientSessionHandle session, ObjectId conversationId, UpdateDefinition<Conversation> update, CancellationToken cancellationToken = default);
}