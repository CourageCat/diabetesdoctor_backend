...
public class CursorPagedResult<T>
{
    ...
    private CursorPagedResult(List<T> items, int pageSize, string nextCursor, bool hasNextPage)
    {
        Items = items;
        PageSize = pageSize;
    ...
    public static CursorPagedResult<T> Create(List<T> items, int pageSize, string nextCursor, bool hasNext)
